...
import { deletePost, getPubldPosts } from "../features/Post/postSlice";
          ...
          <Col md="10">
            <Card className="strpied-tabled-with-hover">
              <Card.Header className="d-flex justify-content-between">
                <div>
                  <Card.Title as="h4">Published Posts</Card.Title>
                    ...
                    {posts?.map((post, i) => {
                      return (
                        <tr key={i}>
                          ...
                          <td>{moment(post?.Post?.createdAt).format("L")}</td>
                          <td>
                            {post?.status ? (
